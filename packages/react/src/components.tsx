...
export function GlassContainer({
  ...
  exposureBlendSubmergedAreaModulationEnabled,
  exposureBlendSubmergedAreaMinStrength,
  exposureBlendSubmergedAreaPeriod,
  exposureBlendSubmergedAreaSharpness,
  exposureBlendSubmergedAreaDelay,
  ior,
  contentIor,
  contentDepth,
  dispersion,

...
export function GlassContainer({
  ...
  normalDivergenceBlendExponentialLambda,
  normalDivergenceBlendGaussianLambda,
  normalDivergenceBlendRationalSoftness,
  normalDivergenceBlendBetaAlpha,
  normalDivergenceBlendBetaBeta,
  normalDivergenceBlendLogisticCenter,
  normalDivergenceBlendLogisticK,
  normalDivergenceBlendEnabled,
  exposureBlendEnabled,
  exposureBlendStrength,
  exposureBlendBandScale,
  exposureBlendMinBand,
  exposureBlendAngleRange,
  exposureBlendAnglePlateau,

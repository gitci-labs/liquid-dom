...
export const NORMAL_GATING_HERMITE_KNEE = 0.7
export const NORMAL_GATING_HERMITE_CAP = 0.84
export const MIN_NORMAL_GATING_HERMITE_PARAMETER = 0
export const MAX_NORMAL_GATING_HERMITE_PARAMETER = 1
export const NORMAL_GATING_HERMITE_PARAMETER_STEP = 0.01
...
export const INITIAL_DISTANCE = 34
export const PLOT_WIDTH = 800
export const PLOT_HEIGHT = 240
export const PLOT_MARGIN = { top: 18, right: 18, bottom: 18, left: 18 }
export const PLOT_STEPS = 96
